...
const Contact: React.FC = () => {
  ...
  return (
      <div>
        ...
        <section  className="section section--first section--last section--head" data-bg="img/bg.jpg">
            ...
            <div  className="row">
                ...
                <div  className="row">
                  ...
                  <div  className="col-12">
                    <form action="/"  className="form form--contacts">
                      ...
                      <textarea name="text"  className="form__textarea" placeholder="Type your message..."> </textarea>
              ...
              <div  className="col-12 col-md-5 col-xl-4">
                <div  className="row">
                  ...
                  <div  className="col-12">
                    <p  className="section__text section__text--mt">It is a long fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>

                    <ul  className="contacts__list">
                      <li><a href="tel:+18092345678">+1 809 234-56-78</a></li>
                      <li><a href="mailto:support@gg.template">support@gg.template</a></li>
                      <li><a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom"  className="open-map">221B Baker St, Marylebone, London</a></li>
                    </ul>
                    <div  className="contacts__social">
                      ...
                      <a  className="tch" href="/">
                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M80 32l-32 80v304h96v64h64l64-64h80l112-112V32zm336 256l-64 64h-96l-64 64v-64h-80V80h304z'/><path d='M320 143h48v129h-48zM208 143h48v129h-48z'/>
                        </svg>
                      </a>
                    </div>
                  </div>
        ...
        <div  className="section section--last">
          <div  className="container">
            <div  className="row">
              <div className="col-12">
                  <OwlCarousel className='owl-theme partners' loop margin={10} nav items={6} dots={false}>
                    <div className='item'>
