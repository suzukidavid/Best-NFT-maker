...
const Subscriptions: React.FC = () => {
    return (
        <OwlCarousel items = {5} className="owl-theme owl-carousel section__carousel section__carousel--catalog" loop margin={10} nav id = 'carousel_1'>
            <div className="card">
              ...
              <div className="card__actions">
                <button className="card__buy" type="button">View</button>
