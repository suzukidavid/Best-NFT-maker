            ...
            <div className="row">
              <div className="col-12">
                <div className="section__wrap">
                  <h2 className="section__title">Gallery <span>(35430 products)</span></h2>
								...
								<div className="collapse filter-wrap__content" id="collapseFilter">
									<div className="filter">
										...
										<div className="filter__group">
											<label className="filter__label" htmlFor="sort">Keyword:
											  <input type="text" className="filter__input" placeholder="Keyword" />
                      </label>
										</div>

										<div className="filter__group">
											<label  htmlFor="sort" className="filter__label">Sort by:
