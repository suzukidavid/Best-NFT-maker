...
export const callSingleMint = async (singleContract, fees, tokenURI, account) => {
  return singleContract.methods
    .mint(fees, tokenURI)
    .send({ from: account })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
...
export const callMultiMint = async (multipleContract, fees, count, tokenURI, account) => {
  return multipleContract.methods
    .mint(fees, count, tokenURI)
    .send({ from: account })
    .on('transactionHash', (tx) => {
      return tx.transactionHash
    })
